  ...
  return (
    <>
        ...
        {active && (
          ...
          >
            <motion.div
              ...
              ref={cardRef}
              className={cn(
                "relative flex h-full w-full max-w-[850px] flex-col overflow-auto bg-white/10 backdrop-blur-lg shadow-sm [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch] [scrollbar-width:none] sm:rounded-t-3xl dark:shadow-none",
                classNameExpanded
              )}
              {...props}
            >
              <motion.div layoutId={`image-${title}-${id}`}>
                <div className="relative before:absolute before:inset-x-0 before:bottom-[-1px] before:z-50 before:h-[70px] before:bg-linear-to-t before:from-zinc-50 dark:before:from-zinc-800">
                  <img
                    src={src}
                    alt={title}
              ...
              <div className="relative h-full before:fixed before:inset-x-0 before:bottom-0 before:z-50 before:h-[70px]">
      ...
      <motion.div
        ...
        className={cn(
          "flex cursor-pointer flex-col items-center justify-between rounded-2xl p-3 shadow-sm bg-white/10 backdrop-blur-lg hover:shadow-md transition-shadow duration-300 dark:shadow-none dark:hover:shadow-md",
          className
        )}
      >
